...
| **typedef**                                               | # `typedef` — old-style type alias<br><br>## Basic example<br><br>`typedef int score; score s = 100;`<br><br>This simply says:<br><br>> “`score` is another name for `int`”<br><br>---<br><br>## Where `typedef` becomes confusing<br><br>### Function pointer example (classic pain)<br><br>`typedef int (*Func)(int, int);`<br><br>Try reading that left-to-right. It’s hard.<br><br>---<br><br>### With templates — impossible ❌<br><br>`typedef std::vector<T> Vec; // ❌ not allowed`<br><br>This is a **huge limitation**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `typedef int score;`                                                                                                                                                                                         |
| **using**                                                 | ## Basic example<br><br>`using score = int; score s = 100;`<br><br>Same result, **much better syntax**.<br><br>---<br><br>## Why `using` is superior<br><br>### 1️⃣ Much clearer with complex types<br><br>`using Func = int(*)(int, int);`<br><br>Readable left-to-right.<br><br>---<br><br>### 2️⃣ Works with templates (major win)<br><br>`template<typename T>` <br>`using Vec = std::vector<T>;`<br>`Vec<int> v;  // std::vector<int>`<br><br>This alone is enough reason to prefer `using`.<br><br>---<br><br>### 3️⃣ Enables cleaner generic code<br><br>`template<typename T>` <br>`struct Traits {`    <br>`using value_type = T; };`<br>---<br>`using IntTraits = Traits<int>;`<br><br>`IntTraits::value_type x = 10;  // value_type is int<br>`<br><br>Used **everywhere** in STL and modern libraries.<br><br>---<br><br># `using` for namespaces<br><br>### Old way<br><br>`std::cout << "Hello"; std::vector<int> v;`<br><br>### Using declaration<br><br>`using std::cout; using std::vector;  cout << "Hello"; vector<int> v;`<br><br>---<br><br>### Using directive (be careful)<br><br>`using namespace std; // ❌ in headers`<br><br>Rule of thumb:<br><br>- ❌ Avoid in headers<br>    <br>- ⚠ Acceptable in `.cpp` or very small scopes | `using T = int;`                                                                                                                                                                                             |
|                                                           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |                                                                                                                                                                                                              |
...
| **Keyword**           | **Purpose**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | **Example / Notes**                                                                                                                                                                                                                                                                                                                                                   |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **const**             | Declares a variable as **read-only** (cannot be modified after initialization).                                                                                                                                                                                                                                                                                                                                                                                                                                               | `const int size = 5;`<br>void print(const std::vector<int>& v) {<br>    // v.push_back(1); ❌ error<br>    std::cout << v.size(); // ✅ allowed<br>}<br><br>int x = 10;<br>const int& r = x;<br>x = 20;        // allowed<br>// r = 30;     ❌<br>                                                                                                                       |
| **constexpr**         | Specifies that a value or function can be evaluated at **compile time**.<br>                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `constexpr int sq(int x) { return x*x; }`<br>## Compile-time configuration (very common)<br><br>`constexpr int MAX_RETRY = 3; constexpr int BUFFER_SIZE = 4096; constexpr double LOAD_FACTOR = 0.75;`<br><br>Why?<br><br>- Used in array sizes<br>    <br>- Template parameters<br>    <br>- Static memory layout<br>    <br><br>`std::array<char, BUFFER_SIZE> buf;` |
...
| **static**            | ### 1️⃣ Static inside function (persistent state)<br><br>`int counter() {     static int count = 0;     return ++count; }`<br><br>- Initialized once<br>    <br>- Lives for program lifetime<br>    <br>### 2️⃣ Static at file scope (internal linkage)<br><br>`static int helper() { return 42; }`<br><br>- Visible **only in this file**<br>    <br>- Prevents symbol collision<br>    <br>### 3️⃣ Static class member<br><br>`struct A {     static int value; };  int A::value = 10;`<br><br>Shared across all instances. | Used for specifying **internal linkage**.                                                                                                                                                                                                                                                                                                                             |
| **thread_local**      | > Like `static`, but **per thread**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | thread_local int threadId = 0;<br><br>void setId(int id) {<br>    threadId = id;<br>}<br>                                                                                                                                                                                                                                                                             |
| **mutable**           | Allows a `const` object to modify a specific member variable.                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | struct Cache {<br>    mutable bool dirty = false;<br><br>    int get() const {<br>        dirty = true; // allowed<br>        return 42;<br>    }<br>};<br>                                                                                                                                                                                                           |
