...
[Remove Duplicates from Sorted Array](https://leetcode.com/problems/remove-duplicates-from-sorted-array): if n[i]== to_check_duplicate: replac e by __ to_check_duplicate = n[i],
